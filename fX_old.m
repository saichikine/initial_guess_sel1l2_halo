function fX = fX(X, c, mu)
	...
	fX(7,6) = 0;
	fX(7,7) = 0;
	fX(7,8) = -ux/(c*(ux^2 + uy^2 + uz^2 + 1/1000000000000)^(1/2));
	fX(7,9) = -uy/(c*(ux^2 + uy^2 + uz^2 + 1/1000000000000)^(1/2));
	fX(7,10) = -uz/(c*(ux^2 + uy^2 + uz^2 + 1/1000000000000)^(1/2));
